...
int main(int argc, char **argv)
{
    ...
    vector<string> gConfigPaths, gDepthConfigPaths;
    ...
    for (int i=0;i<nAgentNum;i++){
        ...
        string aIndex;
        ss >> aIndex;
        n.getParam("config_file_depth_"+aIndex, aLocalConfigFile);
        gDepthConfigPaths.push_back(aLocalConfigFile);
    ...
    CollaborativeServer * pServer = new CollaborativeServer(aVocFile, gConfigPaths, gDepthConfigPaths, aProjectPath, n);
