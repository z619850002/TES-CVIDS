...
{
public:
    float m_nPlottingScale;
	ServerPlotter(){
    	float fps = 10;

        this->m_nPlottingScale = 1.5;
...
public:
    ...
    void Run(){
        ...
        for (int i=0;i<4;i++){
            cv::Mat mImage = cv::Mat::zeros(360/this->m_nPlottingScale,480/this->m_nPlottingScale,CV_8UC3);
            this->m_gCurrentImages.push_back(mImage);
        }
        this->m_mLoopClosureImage = cv::Mat::zeros(360/this->m_nPlottingScale,960/this->m_nPlottingScale,CV_8UC3);
    ...
    void AddKeyFrame(ServerKeyFrame * pKeyFrame){
        ...
        // this->UpdateCurrentImage(pKeyFrame->m_mColoredImage, pKeyFrame->m_nClientID);
    	this->m_mKeyFrameMutex.unlock();
    }
    ...
    cv::Mat GenerateCurrentFrames(){
        this->m_mCurrentImageMutex.lock();
        cv::Mat mImage = cv::Mat::zeros(360*2/this->m_nPlottingScale,960/this->m_nPlottingScale,CV_8UC3);

        cv::Rect iRect1(0/this->m_nPlottingScale, 0/this->m_nPlottingScale, 480/this->m_nPlottingScale, 360/this->m_nPlottingScale);
        cv::Mat mDst1 = mImage(iRect1);

        cv::Rect iRect2(480/this->m_nPlottingScale, 0/this->m_nPlottingScale, 480/this->m_nPlottingScale, 360/this->m_nPlottingScale);
        cv::Mat mDst2 = mImage(iRect2);

        cv::Rect iRect3(0/this->m_nPlottingScale, 360/this->m_nPlottingScale, 480/this->m_nPlottingScale, 360/this->m_nPlottingScale);
        cv::Mat mDst3 = mImage(iRect3);

        cv::Rect iRect4(480/this->m_nPlottingScale, 360/this->m_nPlottingScale, 480/this->m_nPlottingScale, 360/this->m_nPlottingScale);
        cv::Mat mDst4 = mImage(iRect4);



// 
        cv::Rect iRectLoopClosure(320/this->m_nPlottingScale, 300/this->m_nPlottingScale, 320/this->m_nPlottingScale, 120/this->m_nPlottingScale);
    ...
    //                 mResizedImage, 
    //                 cv::Size(480/this->m_nPlottingScale, 360/this->m_nPlottingScale)); 
    ...
    void UpdateLoopClosureImage(cv::Mat mImage){
        ...
        cv::resize( m_mLoopClosureImage,
                    m_mLoopClosureImage,
                    cv::Size(960/3/this->m_nPlottingScale, 360/3/this->m_nPlottingScale));
